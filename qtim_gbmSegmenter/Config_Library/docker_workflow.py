...
def full_pipeline(T2_folder, T1_folder, T1POST_folder, FLAIR_folder, final_output_folder, bias, preprocessed):
    ...
    # Alternate workflow for DeepInfer
